...
namespace Ev.ServiceBus.IntegrationEvents.UnitTests
{
    public class SubscriptionConfigurationTest
    {
        ...
        {
            var services = new ServiceCollection();
            var reg = services.RegisterServiceBusReception()
                .FromSubscription("topic", "sub")
                .RegisterReception<SubscribedEvent, SubscribedEventHandler>();
        ...
        public async Task HandlerCannotReceiveFromTheSameSubscriptionTwice()
        {
            ...
            {
                var builder = services.RegisterServiceBusReception().FromSubscription("topicName", "subscriptionName");
        ...
        public async Task HandlerCannotReceiveFromTheSameQueueTwice()
        {
            ...
            composer.WithAdditionalServices(services =>
            {
                var builder = services.RegisterServiceBusReception().FromQueue("queueName");
                builder.RegisterReception<SubscribedEvent, SubscribedEventHandler>();
                builder.RegisterReception<SubscribedEvent, SubscribedEventHandler>();
            });
        ...
        public async Task EventTypeIdCannotBeSetTwice()
        {
            ...
            composer.WithAdditionalServices(services =>
            {
                var reg = services.RegisterServiceBusReception().FromQueue("queueName");

                reg.RegisterReception<SubscribedEvent, SubscribedEventHandler>().CustomizeEventTypeId("testEvent");
                reg.RegisterReception<SubscribedEvent, SubscribedEventHandler2>().CustomizeEventTypeId("testEvent");
            });
        ...
        public void ReceiveFromQueue_ArgumentCannotBeNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() =>
            {
                services.RegisterServiceBusReception().FromQueue(null);
            });
        }
        ...
        public void ReceiveFromSubscription_ArgumentCannotBeNull(string topicName, string subscriptionName)
        {
            ...
            Assert.Throws<ArgumentNullException>(() =>
            {
                services.RegisterServiceBusReception().FromSubscription(topicName, subscriptionName);
            });
        }
