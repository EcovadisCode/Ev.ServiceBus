...
public class ReceptionBuilder
{
    ...
    public void FromQueue(string queueName, Action<ReceptionRegistrationBuilder> settings)
    {
        ...
        var queue = new QueueOptions(_services, queueName);
        queue.WithCustomHandlerOptions(_ => {});
        ...
        Action<ReceptionRegistrationBuilder> settings)
    {
        ...
        var subscriptionOptions = new SubscriptionOptions(_services, topicName, subscriptionName);
        subscriptionOptions.WithCustomHandlerOptions(_ => {});
