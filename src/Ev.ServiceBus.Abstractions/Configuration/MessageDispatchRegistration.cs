...
{
    private readonly List<Action<ServiceBusMessage, object>> _outgoingCustomizers;
        ...
        Type payloadType)
    {
        ...
        _outgoingCustomizers = new List<Action<ServiceBusMessage, object>>();
    }
    ...
    /// </summary>
    internal IReadOnlyList<Action<ServiceBusMessage, object>> OutgoingMessageCustomizers => _outgoingCustomizers;
    ...
    /// <returns></returns>
    public MessageDispatchRegistration CustomizeOutgoingMessage(Action<ServiceBusMessage, object> messageCustomizer)
    {
